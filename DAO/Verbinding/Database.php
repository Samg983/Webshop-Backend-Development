...
class Database {
    ...
    public function voerSqlInsertQueryUit($mijnSqlQuery, $parameterArray = null) {
        return $this->voerAdvancedInsertSqlQueryUit($mijnSqlQuery, true, $parameterArray);
    }
    ...
    protected function voerAdvancedSqlQueryUit($mijnSqlQuery, $verbindingAutomatischVerbreken = true, $parameterArray = null) {
     ...
     protected function voerAdvancedInsertSqlQueryUit($mijnSqlQuery, $verbindingAutomatischVerbreken = true, $parameterArray = null) {
        $this->maakVerbindingMetDatabase();
        if ($parameterArray != null) {
            //Verander alle vraagtekens in de query door parameterwaarden uit de parameterArray
            $queryParts = preg_split("/\?/", $mijnSqlQuery);
        ...
        $this->mijnVerbinding->query($mijnSqlQuery);
        $resultaat = $this->mijnVerbinding->insert_id;
